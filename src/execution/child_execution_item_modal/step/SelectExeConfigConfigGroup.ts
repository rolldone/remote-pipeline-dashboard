...
import SelectExeConfig from "./SelectExeConfigConfig";

const SelectExeConfigConfigGroup = SelectExeConfig.extend<BaseRactiveInterface>({
  template: /* html */`
...
export default SelectExeConfigConfigGroup;
...
const SlackHook = SmtpHook.extend<SmtpHookInterface>({
  template:/* html */`
  <div class="modal-body">
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="text" placeholder="https://hooks.slack.com/service/xxxxx/xxx..." value="{{form_data.webhook_url}}" name="webhook_url">
    </div>
  </div>

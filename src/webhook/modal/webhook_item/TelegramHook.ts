...
const TelegramHook = SmtpHook.extend<SmtpHookInterface>({
  template:/* html */`
    <div class="modal-body">
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="text" placeholder="https://api.telegram.org/bot<yourtoken>" value="{{form_data.webhook_url}}" name="webhook_url">
      </div>
      <div class="mb-3">
        <label class="form-label">Chat Id</label>
        <input class="form-control" type="text" placeholder="chat id" value="{{form_data.chat_id}}" name="chat_id">
      </div>
    </div>
